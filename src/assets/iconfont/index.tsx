...
export type IconNames = 'icon-WeatherSunny' | 'icon-Cloud' | 'icon-bx-detail' | 'icon-set' | 'icon-set1' | 'icon-set2';
...
let IconFont: FunctionComponent<Props> = ({ name, ...rest }) => {
  switch (name) {
    case 'icon-WeatherSunny':
      return <IconWeatherSunny key="1" {...rest} />;
    case 'icon-Cloud':
      return <IconCloud key="2" {...rest} />;
    case 'icon-bx-detail':
      return <IconBxDetail key="3" {...rest} />;
    case 'icon-set':
      return <IconSet key="4" {...rest} />;
    case 'icon-set1':
      return <IconSet1 key="5" {...rest} />;
    case 'icon-set2':
      return <IconSet2 key="6" {...rest} />;
  }
